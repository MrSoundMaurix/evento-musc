                    ...
                    <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                        <div class="product-payment-inner-st res-mg-t-30 analysis-progrebar-ctn">
                            <div class="row">
                                ...
                                <div class="col-xs-1">
                                        <a style="position:absolute;right:0px;" href="{{route('admin-talleres.edit',$taller->tal_id)}}"><button data-toggle="tooltip" title="Editar" class="pd-setting-ed"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button></a>
                                </div>
                            </div>
